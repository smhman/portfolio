...
<div style="margin-top: 20px; border-radius: 13px; overflow: hidden;">
    <iframe title="Katarsis - Tavo akys | Spotify" src="https://open.spotify.com/embed/track/1imPa2lzxmLKggLCpkBAoo" width="100%" height="352" frameBorder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
</div>
